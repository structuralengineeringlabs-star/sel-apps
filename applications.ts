...
export const applications: Application[] = [
  ...
  },
  {
    ...
    shortDescription: "Dimensionne les escaliers en béton armé, acier ou bois : volées droites et quart tournant, note PDF et plans DXF.",
    longDescription: "Dimensionne les escaliers selon les Eurocodes : paillasse en béton armé (EC2), limons en acier (EC3) ou en bois (EC5), volées droites avec ou sans paliers et escaliers à quart tournant. Vérifications de flexion, d'effort tranchant, de flèche, d'enrobage, d'ancrage et de la marche sous charge ponctuelle ; optimiseur de ferraillage, de profilé ou de section ; note de calcul PDF, plans d'exécution DXF (coupe de ferraillage avec croisement anti-poussée au vide) et métrés. Aide intégrée et guide d'utilisation PDF.",
    categorySlug: "batiments",
    isFree: true,
    isNew: true,
    appUrl: "/apps/escaliers",
    icon: "TrendingUp",
    tags: ["Escalier", "EC2", "EC3", "EC5", "Quart tournant", "DXF"],
  },
  {
    id: 7,
    slug: "corbeaux",
  ...
  },
  {
    ...
    longDescription: "Trace et analyse la courbe granulométrique des granulats à partir des résultats d'analyse par tamisage et sédimentométrie : comparaison multi-échantillons, calcul de D10 à D85, Cu, Cc, classification GTR indicative et critères de filtre de Terzaghi.",
    categorySlug: "geotechnique",
    isFree: true,
